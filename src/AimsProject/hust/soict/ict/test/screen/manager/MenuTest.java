...
public class MenuTest {
    public static void main(String[] args) {
        ...
        Book book5 = new Book(5, "Aladin 2", "Animation", (int) 15.32f, "Author 3", "Author 4");
        Book book10 = new Book(10, "Aladin 37", "Animation", (int) 15.2f, "Author 4");
        Book book11 = new Book(11, "Aladin 36", "Animation", (int) 15.2f, "Author 7");
        Book book12 = new Book(12, "Aladin 5", "Animation", (int) 15.2f, "Author 4z");
        Book book13 = new Book(13, "Aladin 4", "Animation", (int) 15.2f, "Author 44");
        Book book14 = new Book(14, "Aladin 3", "Animation", (int) 15.2f, "Author 4564");
